...
const TWITTER_HANDLE = "fukuraming";
const TWITTER_LINK = `https://twitter.com/${TWITTER_HANDLE}`;
const OPENSEA_LINK = "";
const TOTAL_MINT_COUNT = 50;
const CONTRACT_ADDRESS = "0xe1367660d92c7DEDf8B456031b25217Dfe7187f9";
const App = () => {
  /*
      ...
      <div className="container">
        <div className="header-container">
          ...
          <button className="cta-button connect-wallet-button">
            <a 
              href="https://testnets.opensea.io/ja/0xdEE4591b421ea3Cf86C78f50AAFBedc95CDb66b7"
              target="_blank"
              rel="noreferrer"
            >OpenSeaでコレクションを表示</a>
          </button>
